...
public class historiqueSeule {
    ...
    public static ResultSet affichetable1(String SITE, Connection Conn) throws Exception{
        String sql = "SELECT * FROM table1 WHERE SITE = '"+SITE+"'";
        Statement st = Conn.createStatement();
        ResultSet resultat = st.executeQuery(sql);
        return resultat;
    }
    
    public static ResultSet affichetable1Tous(Connection Conn) throws Exception{
        String sql = "SELECT * FROM table1 ORDER BY SITE ASC";
        Statement st = Conn.createStatement();
        ResultSet resultat = st.executeQuery(sql);
        return resultat;
    }
    public static ResultSet afficheToutTable1(Connection Conn) throws Exception{
        String sql = "SELECT * FROM table1";
        Statement st = Conn.createStatement();
        ResultSet result = st.executeQuery(sql);
        return result;
    }
        public static ResultSet affichePF(String PF, Connection con) throws Exception{
        String sql = "SELECT PF FROM table1 GROUP BY PF HAVING COUNT(*) >= 1";
